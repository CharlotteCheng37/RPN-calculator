...
class VariableExpressionTest {
    ...
    void testOptimizeUnbound() {
        ...
        assertEquals(new Variable("x"), opt);
    }
}
...
class OperationExpressionTest {
    ...
    void testEvalAddUnbound() {
        Expression expr = new Operation(Operator.ADD, new Variable("y"),
                new Constant(2));
        assertThrows(UnboundVariableException.class, () -> expr.eval(MapVarTable.of("x",
                1.5)));
    }
    ...
    void testOptimizeAdd() {
        Expression expr = new Operation(Operator.ADD, new Constant(2), new Constant(5));
        assertEquals(new Constant(7), expr.optimize(MapVarTable.empty()));
    }
}
...
class ConditionalExpressionTest {
    ...
    void testEvalCondBound() throws UnboundVariableException {
        ...
        assertEquals(2.0, expr1.eval(MapVarTable.of("x", 1.0)));

        Expression expr2 = new Conditional(new Variable("x"), new Constant(2), new Constant(5));
        assertEquals(5.0, expr2.eval(MapVarTable.of("x", 0.0)));
    }
    ...
    void testEvalCondUnbound() {
        ...
        assertThrows(UnboundVariableException.class, () -> expr.eval(MapVarTable.of("y",
                1.5)));
    }
    ...
    void testInfixLeaves() {
        Expression expr = new Conditional(new Variable("x"), new Constant(2), new Constant(5));
        assertEquals("(x ? 2.0 : 5.0)", expr.infixString());
    }
    ...
    void testPostfixLeaves() {
        Expression expr = new Conditional(new Variable("x"), new Constant(2), new Constant(5));
        assertEquals("x 2.0 5.0 ?:", expr.postfixString());
    }
    ...
    void testEqualsFalseCondition() {
        Expression expr1 = new Conditional(
                ...
                new Constant(7));
        Expression expr2 = new Conditional(
                new Operation(Operator.ADD, new Variable("x"), new Constant(4)),
                new Operation(Operator.MULTIPLY, new Constant(2), new Variable("y")),
                new Constant(7));
        assertFalse(expr1.equals(expr2));
    }
    ...
    void testEqualsFalseBranch() {
        ...
        Expression expr2 = new Conditional(
                new Operation(Operator.ADD, new Variable("x"), new Constant(3)),
                new Operation(Operator.SUBTRACT, new Constant(2), new Variable("y")),
                new Constant(7));
        assertFalse(expr1.equals(expr2));
    }
    ...
    @Test
    @DisplayName("A Conditional node with Constant condition should optimize to its appropriate "
            + "optimized branch")
    void testOptimizeConstCondition() {
        Expression expr = new Conditional(
                ...
                new Operation(Operator.ADD, new Variable("x"), new Constant(3)),
                new Operation(Operator.MULTIPLY, new Constant(2), new Variable("y")));
        assertEquals(new Constant(4), expr.optimize(MapVarTable.of("x", 1.0)));
    }
